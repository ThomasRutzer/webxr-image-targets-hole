import { XrTrackedImage } from "./xrTrackedImage.js";
...
XrImageTracking.prototype.onSessionStart = function (session) {
  var self = this;

  session.getTrackedImageScores().then(function (images) {
...
XrImageTracking.prototype.onSessionEnd = function () {
  this._available = false;
